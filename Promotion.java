...
public class Promotion{
    public void promotion() throws FileNotFoundException {
        System.out.println("----------!!Best Promotion!!----------");
        File file = new File("C:/Users/maxwi/Desktop/1-2564/308-331 OOP/Final/Promotion.txt"); //อ่านไฟล์ใน .txt
        ...
        try{
            ...
            BufferedReader r = new BufferedReader(new FileReader("C:/Users/maxwi/Desktop/1-2564/308-331 OOP/Final/Price/Promotion.txt"));
            String s = "";
            ...
            r.close();
            System.out.printf("[1] Pack book Demon Slayer, Volume 1-23       Price : %.2f\n",buy1);
            System.out.printf("[2] Pack Boruto Next Generation, Volume 1-9   Price : %.2f\n",buy2);
            System.out.printf("[3] Pack Naruto, Volume 1-10                  Price : %.2f\n",buy3);
            System.out.printf("[4] Pack Detective Cona Limited Edition       Price : %.2f\n",buy4);
            System.out.printf("[5] Attack on Titan Book and Poster           Price : %.2f\n",buy5);
            ...
            if (ba1 == 1){
                ...
                System.out.println("There are currently no promotions.");
            }
            else{
                clrscr();
